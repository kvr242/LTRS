...
namespace LTRS.App_Code.DataSet1TableAdapters {
    ...
    public partial class USER_MASTERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [USER_MASTER] WHERE (([USER_ID] = @Original_USER_ID))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [USER_MASTER] SET [FIRST_NAME] = @FIRST_NAME, [LAST_NAME] = @LAST_NAME, [USER_NAME] = @USER_NAME, [PASSWORD] = @PASSWORD, [DBA_PASSWORD] = @DBA_PASSWORD, [PHONE_NUMBER] = @PHONE_NUMBER, [RECOVERY_EMAIL] = @RECOVERY_EMAIL, [ADDRESS] = @ADDRESS, [CITY] = @CITY, [STATE] = @STATE, [ZIPCODE] = @ZIPCODE, [USER_STATUS] = @USER_STATUS WHERE (([USER_ID] = @Original_USER_ID))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        USER_ID, FIRST_NAME, LAST_NAME, USER_NAME, PASSWORD, DBA_PASSWORD, " +
                "PHONE_NUMBER, RECOVERY_EMAIL, ADDRESS, CITY, STATE, ZIPCODE, USER_STATUS\r\nFROM  " +
                "          USER_MASTER";
        ...
        public virtual int Fill(DataSet1.USER_MASTERDataTable dataTable) {
        ...
        public virtual DataSet1.USER_MASTERDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1.USER_MASTERDataTable dataTable = new DataSet1.USER_MASTERDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.USER_MASTERDataTable dataTable) {
